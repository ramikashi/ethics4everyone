...
def change(parent_label, count, e, cond=False):
    ...
    #if there's no ( or prefix, this will return the whole string.
    #This also works if it's just (a statement like this)
    #if len(e.split('(')) == 1:
    #    clean_e = e
...
def main():
    dataDirPath = ""
    Ja_jsonFileName = "BenchmarkDecisionTree15refs和最新版.json"
    Eng_jsonFileName = "BenchmarkDecisionTree15refs.json"
